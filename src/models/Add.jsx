...
export default function AddProd() {
    ...
    <>
        ...
        <div className="flex flex-row items-center">
            ...
            <IconButton className="w-5 h-5 bg-transparent shadow-none">
                <AiOutlineClear className="w-5 h-5 fill-black" />
            </IconButton>
            </Tooltip>
            <Tooltip content="Exit Form" className="bg-red-600 h-7 text-xs">
            <IconButton className="w-5 h-5 bg-transparent shadow-none">
                <MdClear className="w-5 h-5 fill-black" />
            </IconButton>
            </Tooltip>
        </div>
        <div id="input-image">
            <Typography className="font-bold text-opacity-40 text-black mt-[10px]">
            Image
            </Typography>
        ...
        <div id="input-type" className="flex flex-row mt-[14px]">
            <Typography className="font-bold text-opacity-40 text-black">
            Type
            </Typography>
            <div>
            <button
                onClick={() => setOpen(!open)}
                className="self-center p-0 ml-4"
            >
                <div className="flex flex-row items-center">
                {dropdownitem === "Menu1" && (
            ...
            {open && (
            <div className="absolute mt-7 bg-[#f6f6f6] rounded-md divide-y-2 ml-[50px] drop-shadow-DashboardShadow">
        ...
        <div id="input-price" className="flex flex-row mt-[5px]">
            <Typography className="font-bold text-opacity-40 text-black ml-[2px]">
            Price
            </Typography>
        ...
        <Button
            className="flex w-40 h-[35px] mt-5 font-bold items-center rounded-full ml-[12%]"
            color="green"
        >

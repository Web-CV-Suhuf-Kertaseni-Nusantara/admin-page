...
export default function DashboardCard() {
    ...
    return (
        <>
            <Card id="card1" className="md:h-[90px] md:w-[200px] w-[250px] bg-[#A88AD4] p-4 self-center md:self-start drop-shadow-DashboardShadow">
            ...
            <Card id="card2" className="md:h-[90px] md:w-[200px] w-[250px] bg-[#B9E303] p-4 self-center md:self-start drop-shadow-DashboardShadow">
                <div className="flex flex-col">
                    <div className="flex flex-row">
                        <div className="p-1 h-[26px] bg-white rounded-lg md:mr-6"><BsFillPersonFill className="h-4 w-4 fill-black"/></div>
            ...
            <Card id="card3" className="md:h-[90px] md:w-[200px] w-[250px] bg-[#B5D5E1] p-4 self-center md:self-start drop-shadow-DashboardShadow">
                <div className="flex flex-col">
                    <div className="flex flex-row">
